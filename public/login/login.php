                ...
                <div class="login_box">
                    ...
                    <div class="login_form">
                        <div class="login_form_inner">
                            ...
                            <div class="text-dark h3 mb-5">WELCOME</div>
                            ...
                            <form action="index.php?action=index&pg=1" method="post"
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="username" name="uname" id="uname"
                                        placeholder="Email">
                                </div>
                                ...
                                <div class="form-group">
                                    <button class="btn btn bg-primary btn-block text-white" type="submit">Log
                                        In</button>
                                </div>
