    ...
    <div class="card height-auto mt-20">
        <div class="card-body">
            ...
            <div class="mg-b-10 text-center">
                <div class="row gutters-8 text-center pr-5 pl-5">
                    <div class="col-6-xxxl col-xl-6 col-lg-6x col-sm-12 form-group">
                    ...
                    <div class="col-3-xxxl col-xl-3 col-lg-3 col-sm-12 form-group">
                        <button type="button"
                            onclick="document.getElementById('pg').value='<?php echo md5('land_sale');?>'; document.getElementById('option').value='<?php echo md5('client'); ?>'; document.getElementById('viewpage').value='search'; document.myform.submit();"
                    ...
                    <div class="col-3-xxxl col-xl-3 col-lg-3 col-sm-12 form-group">
                        <button type="submit"
                            onclick="document.getElementById('pg').value='<?php echo md5('land_sale');?>'; document.getElementById('option').value='<?php echo md5('client'); ?>'; document.getElementById('viewpage').value='reset'; document.getElementById('fdsearch').value=''; document.myform.submit(); "
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <button type="button" class="btn btn-fill-md text-15 bg-info text-light "
                                    onclick="document.getElementById('pg').value='<?php echo md5('land_sale');?>'; document.getElementById('option').value='<?php echo md5('add'); ?>'; document.getElementById('viewpage').value='client_details'; document.getElementById('keys').value='<?php echo $objCode; ?>'; document.myform.submit(); ">
                                    <span class="fa fa-plus"></span> Sell Land</button>
