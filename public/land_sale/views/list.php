                ...
                <div class="dashboard-content-one">
                    <div style="text-align:right; margin-top: 20px; margin-bottom: 20px;">
                        ...
                        <a href="index.php?pg=<?php echo md5('land_sale');?>&option=<?php echo md5('client'); ?>" type=""
                            class="btn btn-fill-md text-15 text-light bg-success"><span class="fas fa-plus"></span> New
                            Sale</a>
                    </div>
                                ...
                                <div class="row gutters-8">
                                    ...
                                    <div class="col-3-xxxl col-xl-4 col-lg-4x col-12 form-group">
                                        <input type="text" id="fdsearch" name="fdsearch"
                                            ...
                                            placeholder="Search by Client ID, Client Name OR Plot Number" class="form-control">
                                    </div>
                            ...
                            <div class="table-responsive">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo$obj->LS_CODE;?></td>
                                            <td><?php echo ucwords(strtolower($obj->LS_CLIENT_NAME));?></td>
                                            <td><?php echo ucwords(strtolower($obj->LS_PROPERTY_NAME));?></td>
                                            <td><?php echo ucwords(strtolower($obj->LS_PLOT_NUMBER));?></td>
                                            <td><?php echo $system_payment_status[$obj->LS_STATUS];?></td>
                                            <td><?php echo ($obj->LS_STATUS == "3")? "N/A": $engine->checkNextPayDate($obj->LS_NEXT_PAY_DATE);?>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            onclick="document.getElementById('pg').value='<?php echo md5('land_sale');?>'; document.getElementById('option').value='<?php echo md5('details'); ?>'; document.getElementById('viewpage').value='details'; document.getElementById('keys').value='<?php echo $objCode; ?>'; document.myform.submit();"><i
                                                                class="fa fa-list text-info"></i> Details</a>
                                                        <?php 
                                                  if($obj->LS_STATUS != "3"){ ?>

                                                        <a class="dropdown-item" href="#"
                                                            onclick="document.getElementById('pg').value='<?php echo md5('land_sale');?>'; document.getElementById('option').value='<?php echo md5('payment'); ?>'; document.getElementById('viewpage').value='details'; document.getElementById('keys').value='<?php echo $objCode; ?>'; document.myform.submit();"><i
