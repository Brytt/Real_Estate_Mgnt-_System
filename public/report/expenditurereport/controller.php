...
switch($viewpage){
  ...
  case "report":     
        ...
        $history_stmt=$sql->GETALL($sql->Prepare("SELECT * FROM expenditure_tb WHERE (EXP_CREATED_DATE BETWEEN ? AND ?) "),array($datefrom,$dateto));
        
        $export_url ="public/report/expenditurereport/view/exportxml.php?&datefrom=".$datefrom."&dateto=".$dateto;
