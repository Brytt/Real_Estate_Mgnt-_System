                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="air-datepicker form-control" onkeydown="return false;"
                                id="datepicker1" placeholder="dd/mm/yyyy" name="datefrom" data-position='bottom right'>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="air-datepicker form-control" id="datepicker2"
                                placeholder="dd/mm/yyyy" name="dateto" data-position='bottom right'>
                            <span id="contact-feedback" class="alert-danger"></span><br>
                        </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="select2 scregion" name="apartment" id="scregion">
                                    <option selected value=" ">All Apartment</option>
