                                ...
                                <table
                                    ...
                                    if(!empty($history_stmt)){
                                        ...
                                        foreach ($history_stmt as $key => $value) {
                                            ...
                                            if ($value['INS_STATUS']=='O') {
                                                  $status='Inactive';                                  
                                            }elseif($value['INS_STATUS']=='1'){
                                                 $status='Active'; 
                                            }elseif($value['INS_STATUS']=='2'){
                                                $status='Pending'; 
                                            }
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td><?php echo $value['INS_FIRST_NAME'].' '.$value['INS_LAST_NAME']?></td>
                                            <td><?php echo $value['INS_EMAIL']??'N/A'?></td>  
                                            <td><?php echo $value['INS_ADDRESS']??'N/A'?></td>  
                                            <td><?php echo $value['INS_CONTACT']??'N/A'?></td>  
                                            <td><?php echo $value['INS_INSPECTION_DATE']??'N/A'?></td>  
                                            <td><?php echo $value['INS_STATUS']??'N/A'?></td>
