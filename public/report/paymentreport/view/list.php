                                ...
                                <table
                                    ...
                                    if(!empty($history_stmt)){
                                            ...
                                            foreach ($history_stmt as $key => $value) {
                                                ...
                                                if ($value['ALT_STATUS']=='O') {
                                                    $status='Inactive';                                  
                                                }elseif($value['ALT_STATUS']=='1'){
                                                    $status='Active'; 
                                                }elseif($value['ALT_STATUS']=='2'){
                                                    $status='Pending'; 
                                                }elseif($value['ALT_STATUS']=='3'){
                                                    $status='Approved'; 
                                                }  
                                      ...
                                      ?>
                                        <tr>
                                            <td><?php echo $n++; ?> </td>
                                            <td><?php echo $value['ALT_CODE']??'N/A'?></td>            
                                            <td><?php echo $value['ALT_CLIENT_NAME']??'N/A'?></td>
                                            <td><?php echo  $value['ALT_PROPERTY_NAME']??'N/A'?></td>  
                                            <td><?php echo $value['ALT_PROPERTY_TYPE']??'N/A'?></td>  
                                            <td><?php echo $value['ALT_TOTAL_PAYMENT']??'N/A'?></td>  
