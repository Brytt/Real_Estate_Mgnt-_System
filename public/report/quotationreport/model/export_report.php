...
class export_report {  
	...
	{	   
		...
		$spreadsheet->getActiveSheet()->SetCellValue('B5', 'FULLNAME');
        $spreadsheet->getActiveSheet()->SetCellValue('C5', 'EMAIL');
		$spreadsheet->getActiveSheet()->SetCellValue('D5', 'CONTACT');
		$spreadsheet->getActiveSheet()->SetCellValue('E5', 'COMMENT');
		$spreadsheet->getActiveSheet()->SetCellValue('F5', 'CREATED DATE');
		...
		$spreadsheet->getActiveSheet()->SetCellValue('A2', 'QUOTATION REPORT'); 
		...
		if(is_array($result) && count($result) > 0){
			...
			{		
				...
				$spreadsheet->getActiveSheet()->SetCellValueByColumnAndRow("2",$i, strtoupper($value['QUT_NAME']));
				$spreadsheet->getActiveSheet()->SetCellValueByColumnAndRow("3",$i, strtoupper($value['QUT_EMAIL']));
				$spreadsheet->getActiveSheet()->SetCellValueByColumnAndRow("4",$i, strtoupper($value['QUT_CONTACT']));
				$spreadsheet->getActiveSheet()->SetCellValueByColumnAndRow("5",$i, strtoupper($value['QUT_COMMENT']));
				$spreadsheet->getActiveSheet()->SetCellValueByColumnAndRow("6",$i, strtoupper($value['QUT_CREATED_DATE']));
		...
		header('Content-Disposition: attachment;filename="Quatation_report"'.date('Y-m-d-H-i').'".xlsx"');
