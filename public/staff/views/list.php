...
<div class="dashboard-content-one">
        <div style="text-align:right; margin-top: 20px; margin-bottom: 20px;">
            ...
            <a href="index.php?pg=<?php echo md5('staff');?>&option=<?php echo md5('add'); ?>" type=""
                class="btn btn-fill-md text-15 text-light bg-primary"><span class="fas fa-plus"></span> STAFF</a>
                <?php } ?>
        </div>
                    ...
                    <div class="row gutters-8">
                        ...
                        <div class="col-3-xxxl col-xl-4 col-lg-4x col-12 form-group">
                            <input type="text" id="fdsearch" name="fdsearch"
                                value="<?php isset($fdsearch)?$fdsearch:""; ?>" placeholder="Search by Staff ID, Name"
                                class="form-control">
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped text-nowrap" style="min-height: 150px;">
                        ...
                        <tbody style="min-height:150px;">
                            ...
                            <tr>
                                <td><?php echo$num++;?></td>
                                <td> <?php echo $obj->STAFF_CODE;?> </td>
                                <td><?php echo ucwords(strtolower($obj->STAFF_FIRSTNAME." ".$obj->STAFF_LASTNAME." ".$obj->STAFF_OTHERNAME));?>
                                </td>
                                <td><?php echo $obj->STAFF_GENDER; ?></td>
                                <td><?php echo $obj->STAFF_CONTACT_1;?></td>

                                <td style="text-align:center;">
                                                    <button class="btn btn-info"  onclick="document.getElementById('pg').value='<?php echo md5('staff');?>'; document.getElementById('option').value='<?php echo md5('details'); ?>'; document.getElementById('viewpage').value='details'; document.getElementById('keys').value='<?php echo $objCode; ?>'; document.myform.submit();"><i
                                                            class="fa fa-list"></i>
                                                Details
                                                </button>
