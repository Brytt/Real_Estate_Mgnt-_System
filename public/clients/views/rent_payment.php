 ...
 <div class="dashboard-content-one">
     <div style="text-align:right; margin-top: 20px; margin-bottom: 20px;">
         ...
         <button type="button" class="btn btn-fill-md text-15 bg-success text-light " onclick="saveRentPayment()">
         ...
         <div class="card-body">
             ...
             <div class="row">
                 ...
                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                     ...
                     <input type="text" placeholder="" value="<?php echo  $obj->AR_BALANCE; ?>" name="" id="ar_balance"
                         class="form-control" readonly>
                 ...
                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                     ...
                     <input type="text" placeholder="" name="payment_date" id="datepicker1"
