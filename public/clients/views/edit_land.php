<div class="dashboard-content-one">
    ...
    <div style="text-align:right; margin-top: 20px; margin-bottom: 20px;">
        ...
        <a href="#"
            onclick="document.getElementById('pg').value='<?php echo md5('client');?>'; document.getElementById('option').value='<?php echo md5('land_details'); ?>'; document.getElementById('viewpage').value='land_pay_details'; document.getElementById('keys').value='<?php echo $obj->LS_CODE; ?>'; document.myform.submit();"
                ...
                <div class="col-md-12 ">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" value="<?php echo  $obj->LS_CLIENT_ID; ?>"
                        ...
                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder=""
                                value="<?php echo  $obj->LS_CLIENT_CONTACT; ?>" name="ls_client_contact"
                        ...
                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" value="<?php echo  $obj->LS_CLIENT_EMAIL; ?>"
                        ...
                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" value="<?php echo  $obj->LS_PLOT_NUMBER; ?>"
                        ...
                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                            ...
                            <input type="number" placeholder="" value="<?php echo  $obj->LS_NUM_OF_PLOT; ?>" onkeypress="allowNumbersOnly(event)"
                        ...
                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" value="<?php echo  $obj->LS_TOTAL_COST; ?>"
                                name="ls_total_cost" id="ls_total_cost" onkeypress="allowNumbersOnly(event)" class="form-control">
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" value="<?php echo  $obj->LS_BALANCE; ?>"
