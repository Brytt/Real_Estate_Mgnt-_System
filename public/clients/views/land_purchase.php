 ...
 <div class="dashboard-content-one">
     <div style="text-align:right; margin-top: 20px; margin-bottom: 20px;">
         ...
         <button type="button" class="btn btn-fill-md text-15 text-light bg-dark"
             onclick="document.getElementById('pg').value='<?php echo md5('client');?>'; document.getElementById('option').value='<?php echo md5('client_landlist'); ?>'; document.getElementById('viewpage').value='land_details'; document.getElementById('keys').value='<?php echo $obj->CLIENT_CODE; ?>';  document.myform.submit();">
             <span class="fas fa-times"></span> Cancel </button>


         <button type="button" class="btn btn-fill-md text-15 bg-success text-light " onclick="SellLand();">
         ...
         <div class="card-body">
             ...
             <div class="heading-layout1 mb-5">
                 <div class="row">
                     ...
                     <div class="text-dark h1 mt-3">PURCHASE</div>
                 </div>
             ...
             <div class="row">
                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                     ...
                     <input type="text" placeholder="" value="<?php echo  $obj->CLIENT_CODE; ?>" name="ls_client_id"
                 ...
                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                     ...
                     <input type="text" placeholder="" value="<?php echo  $obj->CLIENT_CONTACT_1; ?>"
                         name="ls_client_contact" id="ls_client_contact" class="form-control" readonly>

                 </div>

                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                     <label>Client Email </label>
                     <input type="text" placeholder="" value="<?php echo  $obj->CLIENT_EMAIL; ?>" name="ls_client_email"
                         id="ls_client_email" class="form-control" readonly>
                 ...
                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                     ...
                     <input type="text" placeholder="" value="" name="ls_plot_number" id="ls_plot_number"
                         class="form-control">
                 ...
                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                     ...
                     <input type="number" placeholder="" value="" name="ls_num_plot" id="ls_num_plot"
                         class="form-control" onkeypress="allowNumbersOnly(event)">
                 ...
                 <div class="col-xl-4 col-lg-6 col-12 form-group">
                     ...
                     <input type="text" placeholder="" value="" name="ls_total_payment" id="ls_total_payment"
